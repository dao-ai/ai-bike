...
import { filterModels, getAllBrands, getAllCategories } from "@/lib/content";
...
type Search = { category?: string; brand?: string };
...
export default async function ModelsPage({
  ...
  const list = filterModels({ categorySlug: category, brandSlug: brand });
